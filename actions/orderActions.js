...
export const createOrder = (order) => async (dispatch, getState) => {
    ...
    try {
        ...
        // ajax request
        const { data } = await Axios.post("https://astech-store.onrender.com/api/orders", order, {
            headers: {
...
export const detailsOrder = (orderId) => async (dispatch, getState) => {
    ...
    try {
        // ajax request
        const { data } = await Axios.get(`https://astech-store.onrender.com/api/orders/${orderId}`, {
    ...
    (order, paymentResult) => async (dispatch, getState) => {
        ...
        try {
            const { data } = Axios.put(
                `https://astech-store.onrender.com/api/orders/${order._id}/pay`,
                paymentResult,
                {
                    headers: { Authorization: `Bearer ${userInfo.token}` },
                }
...
export const myOrderHistory = () => async (dispatch, getState) => {
    ...
    try {
        const { data } = await Axios.get("https://astech-store.onrender.com/api/orders/purchase", {
            headers: {
                Authorization: `Bearer ${userInfo.token}`,
            },
        });
...
export const listOrders = () => async (dispatch, getState) => {
    ...
    try {
        const { data } = await Axios.get("https://astech-store.onrender.com/api/orders", {
            headers: { Authorization: `Bearer ${userInfo.token}` },
        });
        console.log(data);
...
export const deleteOrder = (orderId) => async (dispatch, getState) => {
    ...
    try {
        const { data } = Axios.delete(`https://astech-store.onrender.com/api/orders/${orderId}`, {
            headers: { Authorization: `Bearer ${userInfo.token}` },
        });
...
export const deliverOrder = (orderId) => async (dispatch, getState) => {
    ...
    try {
        const { data } = Axios.put(
            `https://astech-store.onrender.com/api/orders/${orderId}/deliver`,
            {},
            {
                headers: { Authorization: `Bearer ${userInfo.token}` },
            }
...
export const summaryOrder = () => async (dispatch, getState) => {
    ...
    try {
        const { data } = await Axios.get("https://astech-store.onrender.com/api/orders/summary", {
            headers: { Authorization: `Bearer ${userInfo.token}` },
        });
