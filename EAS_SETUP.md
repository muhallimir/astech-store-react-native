...
Linked to `@amirsali/astech-react-native` on EAS. Three build profiles configured.
...
(Already done for this repo: project ID `43087935-83ea-4a1f-847b-2c803e1cd270` is in `app.json`.)
...
|---|---|---|
| `6047837b-f7ed-4d99-8cb6-85eb982aad77` | FINISHED | https://expo.dev/artifacts/eas/MfHytFwuKDLCJ19_qlgF1HNv6ntA7GDYs0al6IMMV2g.tar.gz |
